...
exports.roomRegister = async (req, res) => {
    ...
    if (time == 'time1') {
        ...
        updatedData['punch_in'] = new Date(splitDate[0], splitDate[1] - 1, splitDate[2], 7, 30, 00, 00);
        updatedData['punch_out'] = new Date(splitDate[0], splitDate[1] - 1, splitDate[2], 9, 30, 00, 00);
        updateRoomQuery = { 'list_time.time1': updatedData };
    } else if (time == 'time2') {
        updatedData['time'] = '10.00 - 12.00';
        updatedData['punch_in'] = new Date(splitDate[0], splitDate[1] - 1, splitDate[2], 10, 0, 00, 00);
        updatedData['punch_out'] = new Date(splitDate[0], splitDate[1] - 1, splitDate[2], 12, 0, 00, 00);
        updateRoomQuery = { 'list_time.time2': updatedData };
    } else if (time == 'time3') {
        updatedData['time'] = '12.30 - 14.30';
        updatedData['punch_in'] = new Date(splitDate[0], splitDate[1] - 1, splitDate[2], 12, 30, 00, 00);
        updatedData['punch_out'] = new Date(splitDate[0], splitDate[1] - 1, splitDate[2], 14, 30, 00, 00);
        updateRoomQuery = { 'list_time.time3': updatedData };
    } else {
        updatedData['time'] = '15.00 - 17.00';
        updatedData['punch_in'] = new Date(splitDate[0], splitDate[1] - 1, splitDate[2], 15, 0, 00, 00);
        updatedData['punch_out'] = new Date(splitDate[0], splitDate[1] - 1, splitDate[2], 17, 30, 00, 00);
